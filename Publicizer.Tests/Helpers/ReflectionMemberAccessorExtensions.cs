...
internal static class ReflectionMemberAccessorExtensions
{
    ...
    public static void SetFieldValue<T>(this ReflectionMemberAccessor reflectionMemberAccessor, object? instance, string fieldName, object? value)
    {
    ...
    public static void SetPropertyValue<T>(this ReflectionMemberAccessor reflectionMemberAccessor, object? instance, string propertyName, object? value)
    {
